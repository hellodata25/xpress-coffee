        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm opacity-80 max-w-xs">
              Africa's premier coffee ordering platform, bringing the finest local beans straight to your doorstep.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/shop" className="hover:underline transition-all">Shop</Link></li>
              <li><Link to="/locations" className="hover:underline transition-all">Locations</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                ...
                123 Coffee Street, Johannesburg, South Africa
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4" />
                info@xpresscoffee.co.za
              </li>
              <li className="flex items-center gap-2">
