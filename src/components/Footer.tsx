...
const Footer = () => {
  ...
  return (
    <footer className="bg-coffee-800 text-cream py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="/shop" className="hover:underline transition-all">Shop</a></li>
              <li><a href="/locations" className="hover:underline transition-all">Locations</a></li>
          ...
          <div>
            <h3 className="font-serif text-lg font-bold mb-4">Business Hours</h3>
            <ul className="space-y-3 text-sm">
        ...
        <div className="border-t border-cream/20 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            ...
            <a href="#" aria-label="Instagram" className="hover:text-terracotta-300 transition-colors">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="#" aria-label="Twitter" className="hover:text-terracotta-300 transition-colors">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
